...
LED_Strobe::LED_Strobe(): mSpeed(-1)
{

}


bool LED_Strobe::setSpeed(const int &speed)
{
    if(mSpeed != speed)
    {
        mSpeed = speed;
...
bool LED_Strobe::setEffects(const QColor &color)
{
...
QColor LED_Strobe::getData(const int &index)
{
